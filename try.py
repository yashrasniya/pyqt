...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.data = [
            ...
            [[["1", True, 999, 999, ], ["2", True, 999, 999, ], ["3", True, 999, 999, ], ["4", True, 999, 999, ],["1", True, 999, 999, ], ["2", True, 999, 999, ], ["3", True, 999, 999, ], ["4", True, 999, 999, ],["1", True, 999, 999, ], ["2", True, 999, 999, ], ["3", True, 999, 999, ], ["4", True, 999, 999, ]],
        ...
        for data, scrollArea_Geometry, scrollAreaWidgetContents_Geometry in self.data:
            ...
            for name, enabled, maximum_number_x, maximum_number_y in data:
                ...
                self.entry_list.append(entry_list)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.invoice_date.setTitle(_translate("MainWindow", "Invoice Date"))
        self.state_of_saleer.setTitle(_translate("MainWindow", "state Of salees"))
        self.state_code_of_saleer.setTitle(_translate("MainWindow", "state code Of salees"))
        self.name.setTitle(_translate("MainWindow", "Name"))
        self.address.setTitle(_translate("MainWindow", "Address"))
        self.state_of_bayer.setTitle(_translate("MainWindow", "state of bayer"))
        self.serial_number.setTitle(_translate("MainWindow", "S.No."))
        self.Name_of_Product.setTitle(_translate("MainWindow", "Name of Product"))
        self.Qty.setTitle(_translate("MainWindow", "Qty"))
        self.Rate.setTitle(_translate("MainWindow", "Rate"))
        self.Amount.setTitle(_translate("MainWindow", "Amount"))
        self.amount_total.setTitle(_translate("MainWindow", "Amount Total"))
        self.tax_amount.setTitle(_translate("MainWindow", "Tax Amount"))
        self.total_amount_after_tax.setTitle(_translate("MainWindow", "Total Amount After Tax"))
        self.total_invoice_amount_in_word.setTitle(_translate("MainWindow", "Total Invoice Amount In Word"))
        self.cgst.setTitle(_translate("MainWindow", "CGST"))
        self.sgst.setTitle(_translate("MainWindow", "SGST"))
        self.cgst_percentage.setTitle(_translate("MainWindow", "CGST %"))
        self.sgst_percentage.setTitle(_translate("MainWindow", "SGST %"))
